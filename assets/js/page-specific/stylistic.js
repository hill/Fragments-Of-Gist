...
var linesB = ["Finally the traffic clears. Morris is on his way! Morris slams on the accelerator, his foot practically touching the floor.","IKEA is in Morris’ sights. The big blue and gold signage looms ahead. Four letters. Infinite pronunciations. Morris skids into parking. The car is engulfed by darkness. He steps out and begins to briskly walk towards the entrance. He stomps along the walkways. Across the crossings. Into the lift. Up the escalator. Through the cafeteria. The coffee shop. The entrance.","The homewares section. One path, infinite routes. Time to look for Lexi. Morris ventures down the predestined path, indicated by the yellow arrows stenciled onto the floor. He shuffles past newlyweds, business assistants, couples, mothers, fathers, children. A gardener. A doctor. A teacher. None of them were Lexi. They were all looking at the same furniture. All seeing different things.","Morris walks. He walks past the variations of bed linen, the variations of alarm clock, the variations of faucet, the variations of mug, of spoon, of lamp. He notices a couple bickering about a style of curtain.","The traffic finally cleared. Morris was on his way! He slammed on the accelerator, his foot practically touching the floor. He arrived at those four looming letters and entered the building. The homewares section. It was time to find Lexi. He ventures down the predestined path so clearly laid out for him. The yellow arrows scattered across the IKEA floor screamed a set direction.", "Morris walked past the countless variations of bed linen, alarm clock, faucet. A mug. A spoon. A lamp. He walked past countless people, all of them looking at the same thing, but seeing different things."]
